...
import { LostSchema } from './schema'; // Validação com Zod
import type { LostAnimalFormSchema } from './type';
import { toast } from '@/hooks/use-toast';
import Header from '../home/header/Header';
import { useNavigate } from 'react-router-dom';
import { useCreateLostAnnouncement } from '../../api/lost-animal/hooks'; // Hook que usa mutate para criar anúncio
...
{currentStep === 2 && (
  <>
    ...
    <div>
      <label htmlFor="address.rua" className="block text-sm font-medium text-gray-700">
        Rua
      </label>
      <input
        id="address.rua"
