  ...
  const onSubmit: SubmitHandler<MissingAnimalFormSchema> = async (data) => {
    try {
      ...
      setShowSuccessMessage(
        'Anúncio de animal desaparecido criado com sucesso!'
      );
    ...
    <>
      ...
      <section id="missing-animal">
        <div className="flex justify-center items-center min-h-screen">
          <div className="w-full max-w-xl bg-gray-100 p-8 rounded-lg shadow-lg mt-16">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="border p-2 rounded w-full"
                />
                {errors.missing_date?.message && (
                  <ErrorsMessage message={errors.missing_date.message} />
                )}
              </div>
              ...
              <div
                {...getRootProps()}
                className="border p-4 rounded w-full cursor-pointer text-center"
              >
                <input {...getInputProps()} />
                <p>
